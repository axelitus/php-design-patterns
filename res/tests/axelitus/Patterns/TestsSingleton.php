...
class SingletonTests extends TestCase
{
    ...
    public function test_behavior()
    {
        ...
        $this->assertTrue($s1 instanceof Creational\Singleton, "The object \$s1 is not an instance of axelitus\\patterns\\Singleton but it should.");
        $this->assertTrue($s1 instanceof Singleton_Concrete, "The object \$s1 is not an instance of axelitus\\patterns\\tests\\Singleton_Concrete but it should.");

        $s2 = Singleton_Concrete::instance();
        $this->assertTrue($s2 instanceof Creational\Singleton, "The object \$s2 is not an instance of axelitus\\patterns\\Singleton but it should.");
        $this->assertTrue($s2 instanceof Singleton_Concrete, "The object \$s2 is not an instance of axelitus\\patterns\\tests\\Singleton_Concrete but it should.");
        ...
        $this->assertTrue($s3 instanceof Creational\Singleton, "The object \$s3 is not an instance of axelitus\\patterns\\Singleton but it should.");
        $this->assertTrue($s3 instanceof Singleton_Concrete, "The object \$s3 is not an instance of axelitus\\patterns\\tests\\Singleton_Concrete but it should.");
