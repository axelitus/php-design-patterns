 ...
 */
class GenericMultiton_ConcreteForgeable extends Creational\GenericMultiton
{
    // define the GenericMultiton instances class
    public static $instances_class = 'axelitus\Patterns\GenericMultiton_ConcreteForgeableInstance';
}
