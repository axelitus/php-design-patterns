 ...
 */
class GenericMultiton_ConcreteForgeable extends src\GenericMultiton
{
    // define the GenericMultiton instances class
    public static $instances_class = 'axelitus\patterns\tests\GenericMultiton_ConcreteForgeableInstance';
}