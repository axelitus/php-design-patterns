...
class SingletonTests extends TestCase
{
    ...
    public function test_behavior()
    {
        ...
        $this->assertTrue($s1 instanceof src\Singleton, "The object \$s1 is not an instance of axelitus\\patterns\\Singleton but it should.");
        ...
        $this->assertTrue($s2 instanceof src\Singleton, "The object \$s2 is not an instance of axelitus\\patterns\\Singleton but it should.");
        ...
        $this->assertTrue($s3 instanceof src\Singleton, "The object \$s3 is not an instance of axelitus\\patterns\\Singleton but it should.");
