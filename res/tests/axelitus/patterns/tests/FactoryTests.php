...
class FactoryTests extends TestCase
{
    ...
    public function test_foo()
    {
        ...
        $foo = $factory->produce();
        $this->assertTrue($foo instanceof src\interfaces\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\interfaces\Forgeable but it should.");
        ...
        $this->assertTrue($foo2 instanceof src\interfaces\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\interfaces\Forgeable but it should.");
    ...
    public function test_bar()
    {
        ...
        $bar = $factory->produce();
        $this->assertTrue($bar instanceof src\interfaces\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\interfaces\Forgeable but it should.");
        ...
        $this->assertTrue($bar2 instanceof src\interfaces\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\interfaces\Forgeable but it should.");
    ...
    public function test_foobar()
    {
        ...
        $this->assertTrue($foobar instanceof src\interfaces\Forgeable, "The object \$foobar is not an instance of axelitus\\patterns\\interfaces\Forgeable but it should.");
