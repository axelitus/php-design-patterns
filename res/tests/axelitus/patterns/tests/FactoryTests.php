...
class FactoryTests extends TestCase
{
    ...
    public function test_foo()
    {
        ...
        $foo = $factory->produce();
        $this->assertTrue($foo instanceof src\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\Forgeable but it should.");
        ...
        $this->assertTrue($foo2 instanceof src\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\Forgeable but it should.");
    ...
    public function test_bar()
    {
        ...
        $bar = $factory->produce();
        $this->assertTrue($bar instanceof src\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\Forgeable but it should.");
        ...
        $this->assertTrue($bar2 instanceof src\Forgeable, "The object \$foo is not an instance of axelitus\\patterns\\Forgeable but it should.");
    ...
    public function test_foobar()
    {
        ...
        $this->assertTrue($foobar instanceof src\Forgeable, "The object \$foobar is not an instance of axelitus\\patterns\\Forgeable but it should.");
